...
> [!NOTE]
> **2FA Implementation**: Two-Factor Authentication (TOTP) is included in this plan as an optional security enhancement. Please confirm if this should be implemented in the initial phase or deferred.
...
- **PATCH** `/users/:id` - Update user
  - Request body: `{ name?, email?, roleId?, avatarUrl?, isActive? }`
